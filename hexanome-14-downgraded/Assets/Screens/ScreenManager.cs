...
public class ScreenManager : MonoBehaviour
{
    ...
    public void initScreens()
    {
        ...
        FightScreen fight = gameObject.GetComponent<FightScreen>();
        screens.Add(screenTag,fight);
        screens[screenTag].init();

        screenTag = "AndorBoard";
        AndorBoardScreen andor = gameObject.GetComponent<AndorBoardScreen>();
        screens.Add(screenTag, andor);
        screens[screenTag].init();
