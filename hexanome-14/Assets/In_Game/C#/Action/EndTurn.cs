...
public class EndTurn : Action
{
    ...
    private int monstersInCastle = 0;
    ...
    public void execute(GameState gs)
    {
        ...
        if (gs.turnManager.roundDone())
        {
            ...
            //foreach (Monster monster in gs.getMonsters().Values)
            //{
            //    if(monster.getLocation() != 0)
            //    {
            //        monster.move();
            //        if (monster.getLocation() == 0)
            //        {
            //            GameState.monstersInCastle += 1;
            //            if (GameState.monstersInCastle == GameState.maxMonstersToLose)
            //            {
